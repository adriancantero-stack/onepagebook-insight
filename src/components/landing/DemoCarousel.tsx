...
// Slides are created inside the component to support i18n
  ...
  const slides = useMemo(() => ([
    {
      ...
      description: t("landing.demo.slide1.desc"),
    ...
    },
    {
      ...
      description: t("landing.demo.slide2.desc"),
    ...
    },
    {
      ...
      description: t("landing.demo.slide3.desc"),
              ...
              >
                <div className="flex-1 flex flex-col justify-center items-center text-center gap-2 sm:gap-3">
                  <div className="inline-flex px-3 py-1 bg-primary/10 rounded-full">
                    <span className="text-xs font-medium text-primary">{t("landing.demo.labels.question")}</span>
                  </div>
                  <p className="text-sm sm:text-base font-semibold text-foreground px-2">
                    {t("landing.demo.sample.question")}
                  </p>
                </div>
                <div className="text-center text-xs text-muted-foreground">
                  {t("landing.demo.labels.tap")}
                </div>
              </div>
              ...
              >
                <div className="flex-1 flex flex-col justify-center items-center text-center gap-2 sm:gap-3">
                  <div className="inline-flex px-3 py-1 bg-green-100 rounded-full">
                    <span className="text-xs font-medium text-green-700">{t("landing.demo.labels.answer")}</span>
                  </div>
                  <p className="text-xs sm:text-sm text-foreground/90 px-2 leading-relaxed">
                    {t("landing.demo.sample.answer")}
                  </p>
                </div>
                <div className="text-center text-xs text-muted-foreground">
                  {t("landing.demo.labels.autoFlip")}
                </div>
              </div>
            </motion.div>
          </div>
    ...
    },
    {
      ...
      description: t("landing.demo.slide4.desc"),
