...
export function BuyOnAmazonButton({
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className={`inline-flex items-center justify-center rounded-xl h-11 px-4 text-sm font-semibold bg-white text-black border border-black hover:bg-[#FF9900] hover:border-[#FF9900] active:bg-[#E68A00] active:border-[#E68A00] focus:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 transition-colors gap-2 ${className}`}
    >
