    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6">
        <header className="w-full text-center pt-8 pb-4">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight animate-fade-in bg-gradient-to-r from-foreground via-primary to-foreground bg-[length:200%_auto] bg-clip-text text-transparent animate-shine">
            OnePageBook
          </h1>
