...
const Summary = () => {
  ...
  const handleShare = async () => {
    ...
    const promoMessages = {
      pt: '📖 Gerado por onepagebook.ai - Resuma qualquer livro em 1 página',
      en: '📖 Generated by onepagebook.ai - Summarize any book in 1 page',
      es: '📖 Generado por onepagebook.ai - Resume cualquier libro en 1 página'
    };
