export const en = {
  translation: {
    ...
    "faq.a1": "A one-page summary generator with key ideas, practical applications, and optional audio in PT/EN/ES.",
    "faq.q2": "What does the free plan include?",
    "faq.a2": "Up to 5 summaries/month and 5 audios/month per user. Premium removes limits and unlocks extras.",
    "faq.q3": "Which languages does the app support?",
    "faq.a3": "Brazilian Portuguese, English, and LATAM Spanish. You can switch languages in the interface.",
    "faq.q4": "How does the app find the correct title and author?",
    "faq.a4": "We verify metadata and normalize spellings; if you only type the title, we try to identify the author automatically.",
    "faq.q5": "Can I trust the summary?",
    "faq.a5": "Yes. We generate summaries with AI trained on popular books, but we always recommend reading the original if you want to go deeper.",
    "faq.q6": "How does audio work?",
    "faq.a6": "We convert text to high-quality voice (TTS). Premium has unlimited audios.",
    "faq.q7": "Can I export to PDF?",
    "faq.a7": "Yes, Premium users can download formatted PDF summaries.",
    "faq.q8": "How do I cancel my subscription?",
    "faq.a8": "Contact us via support email. Cancellation is immediate with no questions asked.",
