export const pt = {
  translation: {
    ...
    "landing.testimonials.testimonial1.quote": "Incrível! Consegui absorver conhecimento de 5 livros em uma semana. Mudou completamente minha rotina de aprendizado.",
