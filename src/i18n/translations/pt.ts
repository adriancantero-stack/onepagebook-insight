export const pt = {
  translation: {
    ...
    "faq.a5": "Sim. Geramos resumos com IA treinada em livros populares, mas sempre recomendamos ler o original se você quiser aprofundar.",
    "faq.q6": "Como funciona o áudio?",
    "faq.a6": "Convertemos o texto em voz (TTS) de alta qualidade. Premium tem áudios ilimitados.",
    "faq.q7": "Posso exportar em PDF?",
    "faq.a7": "Sim, usuários Premium podem baixar resumos em PDF formatado.",
    "faq.q8": "Como cancelo minha assinatura?",
    "faq.a8": "Entre em contato pelo email de suporte. Cancelamento é imediato sem perguntas.",
