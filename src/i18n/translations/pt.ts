export const pt = {
  translation: {
    ...
    home: {
      ...
      top10Title: "Top 10 Mais Populares"
    },
    ...
    landing: {
      hero: {
        ...
        subheadline: "A IA do OnePageBook transforma cada leitura em aprendizado real — com flashcards inteligentes que ajudam você a lembrar e aplicar o conhecimento no dia a dia.",
      ...
      howItWorks: {
        title: "Como funciona",
        step1: { title: "Escolha o livro", description: "Navegue por nossa biblioteca ou pesquise qualquer livro" },
        step2: { title: "A IA cria o resumo e gera os flashcards", description: "Nossa IA processa o livro e transforma em conteúdo de aprendizado" },
      ...
      finalCta: {
        ...
        subtext: "Ler é bom. Aprender e lembrar é melhor. Torne-se 1% melhor por dia com o poder da IA e dos flashcards inteligentes.",
    ...
    "welcome.limits": "3 resumos + 3 áudios por mês",
    ...
    // Limits
    "limit.toasts.summary.ok": "Resumo gerado! Você usou {used}/3 neste mês.",
    "limit.toasts.summary.hard": "Você atingiu o limite de 3 resumos deste mês.",
    "limit.toasts.audio.ok": "Áudio gerado! Você usou {used}/3 neste mês.",
    "limit.toasts.audio.hard": "Você atingiu o limite de 3 áudios deste mês.",
    ...
    "landing.testimonials.testimonial2.text": "Agora eu lembro o que li semanas depois.",
    "landing.testimonials.testimonial2.author": "Ana Santos",
    "landing.testimonials.testimonial2.role": "Designer",
    "landing.testimonials.testimonial2.quote": "Agora eu lembro o que li semanas depois.",
    ...
    "landing.plans.free.feature4": "30 Flashcards Interativos",
